...
namespace BlazorServerSQLite.Managers
{
    public class StripeManager
    {
        ...
        public async Task<APIResultModel> ActivateSubscriptionAsync(StripeBillingRequest subReq)
        {
            ...
            StripeConfiguration.ApiKey = "sk_test_51M3OgEB7gExS6ksv6opxrkjJLKzr0dI8iMOlNdHTcO8Vizlc115A2nDfdJ5jxNMsB5ilvkFCxKWnP2IGbzwTwIn5001SFAwnHx";
